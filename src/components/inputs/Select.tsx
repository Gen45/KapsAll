export const Select = ({ labelText }: { labelText: string }) => {
    return (
        <div>
            <label id="listbox-label" className="block text-sm font-medium leading-6 text-gray-900">{labelText}</label>
            <div className="relative mt-2">
                ...
                <ul className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" tab-index="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3">
